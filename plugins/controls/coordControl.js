...
L.Control.Coordinates = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        //input containers
        this._inputcontainer = L.DomUtil.create("div", "uiElement container bg-dark", container);
        ...
        this._inputxcontainer = L.DomUtil.create('div', 'col pr-1', this._coordcontainer)
        this._inputX = this._createInput("inputX", this._inputxcontainer);
        this._inputX.placeholder = "X";
        this._inputycontainer = L.DomUtil.create('div', 'col pl-1', this._coordcontainer)
        ...
        this._mapidcontainer = L.DomUtil.create('div', 'col', this._idcontainer)
