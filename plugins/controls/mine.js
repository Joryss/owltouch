...
L.Control.Miner = L.Control.extend({
  ...
  onAdd: function(map) {
    ...
    var className = "leaflet-control-miner container-resources";
    ...
    this._aButton = L.DomUtil.create("a", "mine-control", container);
      ...
      for (const key in json[this.resources[j]]) {
        if (
          ...
          L.marker(
            ...
            {
              icon: L.divIcon({
                iconUrl: `./data/assets/mine/${this.resources[j]}.png`,
                html: `<img src="./data/assets/mine/${
                  this.resources[j]
                }.png"><div class="qnt1">${
                ...
                className: "mycluster",
                iconAnchor: [
                  sizeOf(`./data/assets/mine/${this.resources[j]}.png`).width /
                    2,
                  sizeOf(`./data/assets/mine/${this.resources[j]}.png`).height /
                    2
                ]
              }),
              interactive: false
