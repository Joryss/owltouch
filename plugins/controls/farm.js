...
L.Control.Farmer = L.Control.extend({
  ...
  onAdd: function(map) {
    ...
    var className = "leaflet-control-farmer container-resources";
    ...
    this._aButton = L.DomUtil.create("a", "farm-control", container);
          ...
          L.marker(
            ...
            ]),
            {
              icon: L.divIcon({
                ...
                className: "mycluster",
                iconAnchor: [
                  sizeOf(`./data/assets/farm/${this.resources[j]}.png`).width /
                    2,
                  sizeOf(`./data/assets/farm/${this.resources[j]}.png`).height /
                    2
                ]
              }),
              interactive: false
