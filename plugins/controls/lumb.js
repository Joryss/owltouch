...
L.Control.Lumber = L.Control.extend({
  ...
  onAdd: function(map) {
    ...
    this._aButton = L.DomUtil.create("a", "lumb-control", container);
          ...
          L.marker(
            ...
            ]),
            {
              icon: L.divIcon({
                ...
                className: "mycluster",
                iconAnchor: [
                  sizeOf(`./data/assets/lumb/${this.resources[j]}.png`).width /
                    2,
                  sizeOf(`./data/assets/lumb/${this.resources[j]}.png`).height /
                    2
                ]
              }),
              interactive: false
